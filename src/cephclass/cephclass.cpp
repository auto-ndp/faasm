                    ...
                    bool writeAllowed)
{
    ...
    try {
        CLS_LOG(5,"Received NDP call request of size %d bytes",(int)inBuffers->length());
        ...
        CLS_LOG(5,"Forwarding call request %llu to the Faasm runtime",static_cast<unsigned long long>(callId));
