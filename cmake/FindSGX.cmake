# Copied from 
# https://raw.githubusercontent.com/xzhangxa/SGX-CMake/master/cmake/FindSGX.cmake

# FindPackage cmake file for Intel SGX SDK

cmake_minimum_required(VERSION 2.8.11...3.10) # target_include_directories
...
if(CMAKE_SIZEOF_VOID_P EQUAL 4)
    ...
    set(SGX_LIBRARY_PATH ${SGX_SDK_PATH}/lib32)
    set(SGX_ENCLAVE_SIGNER ${SGX_SDK_PATH}/bin/x86/sgx_sign)
    set(SGX_EDGER8R ${SGX_SDK_PATH}/bin/x86/sgx_edger8r)
else()
    set(SGX_COMMON_CFLAGS -m64)
    set(SGX_LIBRARY_PATH ${SGX_SDK_PATH}/lib64)
    set(SGX_ENCLAVE_SIGNER ${SGX_SDK_PATH}/bin/x64/sgx_sign)
...
if(SGX_INCLUDE_DIR AND SGX_LIBRARY_DIR)
    set(SGX_FOUND "YES")
    set(SGX_INCLUDE_DIR "${SGX_SDK_PATH}/include" CACHE PATH "Intel SGX include directory" FORCE)
...
if(SGX_FOUND)
    ...
    set(APP_INC_DIRS "${SGX_SDK_PATH}/include")
    ...
    function(_build_edl_obj edl edl_search_paths use_prefix)
        ...
        endforeach()
        list(APPEND SEARCH_PATHS "${SGX_SDK_PATH}/include")
