...
//
// We've used the version from 5.13 because that's what we end up with when
// we've installed HWE at the time of writing (25/02/22).
//
// We should switch to using the system-wide version as soon as it includes
// everything we need.
//
// Original version:
// https://raw.githubusercontent.com/torvalds/linux/v5.13/include/uapi/linux/userfaultfd.h
// ------------------------------------------------------
...
#define UFFD_API_RANGE_IOCTLS                                                  \
    ((__u64)1 << _UFFDIO_WAKE | (__u64)1 << _UFFDIO_COPY |                     \
     (__u64)1 << _UFFDIO_ZEROPAGE | (__u64)1 << _UFFDIO_WRITEPROTECT |         \
